<template>
  <div id="home_page">
    ...
    <div class="guide">
      ...
      <p class="guideText" @click="gameListOn(true)">
        Activity List
      </p>
    </div>

    <div v-if="gameListFlag" class="list_wrap">
      <h2 class="hidden">
        game_list
      </h2>
      <button class="closeList" @click="gameListOn(false)" />
      <ul class="list">
        <li v-for="(v, i) in gameList" :key="i" @click="goLink(v.link, i)">
          <p class="label">
            {{ v.label }}
          </p>
          <img
    ...
    <div class="pc">
      ...
      <swiper class="swiper" :options="swiperOption">
        <swiper-slide v-for="(v, i) in gameList" :key="i" class="swiper-wrap">
          <div class="wrap" @click="goLink(v.link, i)">
            <p class="label">
              {{ v.label }}
            </p>
            <div class="imgBox">
